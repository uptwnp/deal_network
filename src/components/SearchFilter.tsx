    ...
    <div className="space-y-2 sm:space-y-3">
      ...
      <div className="relative flex items-center flex-wrap gap-2 text-sm sm:text-base">
        ...
        <div className="relative flex items-center gap-1" ref={areaDropdownRef}>
          ...
          {showAreaDropdown && (
            <div className="absolute right-0 sm:left-0 top-full mt-1 bg-white border border-gray-300 rounded-lg shadow-lg max-h-96 overflow-y-auto z-[200] w-full min-w-[240px] sm:min-w-[280px]">
