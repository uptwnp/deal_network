    ...
    return (
        <div className={`bg-white h-full flex flex-col ${className}`}>
            ...
            <div className="p-4 sm:p-6 space-y-3 sm:space-y-4 md:space-y-6 overflow-y-auto flex-1">
                ...
                {(selectedHighlights.length > 0 || isOwned) && (
                    <div>
                    ...
                    <div className="pt-2 border-t border-gray-200">
                        <div className="flex items-center justify-between gap-3">
                            ...
                            <button
                                ...
                                className={`flex items-center gap-1.5 px-2 py-1.5 rounded-lg border transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 ${property.is_public === 1
                                                        ...
                                                        {highlightsWithIcons.map((highlight) => {
                                                            ...
                                                            return (
                                                                <button
                                                                    ...
                                                                    className={`px-4 py-2 rounded-xl transition-colors text-sm flex items-center gap-2 ${selectedHighlights.includes(highlight.text)
                                                    ...
                                                    <div className="flex flex-wrap gap-2">
                                                        {tagOptions.map((tag) => (
                                                            <button
                                                                ...
                                                                className={`px-4 py-2 rounded-xl transition-colors text-sm ${selectedTags.includes(tag)
                                                                    ? 'bg-blue-50 text-blue-700 font-medium'
                                                                    : 'bg-gray-50 text-gray-700 hover:bg-gray-100'
                                                                    }`}
                                                            >
            ...
            {showFavModal && (
                <div className="fixed inset-0 z-[60] flex items-center justify-center bg-black/50 p-4 mobile-modal-container">
                    <div className="bg-white rounded-2xl shadow-xl w-full max-w-md mobile-modal-content animate-fade-in p-6">
                        <div className="flex items-center justify-between mb-4">
                            <h3 className="text-lg font-bold text-gray-900">Personal Note</h3>
                            <button
                        ...
                        <div className="space-y-4">
                            <p className="text-sm text-gray-600">
                                Add a private note to this property. This note is only visible to you.
                            </p>
                            <textarea
                                value={noteDraft}
                                onChange={(e) => setNoteDraft(e.target.value)}
                                placeholder="Enter your note here..."
                                className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent min-h-[120px] resize-none"
                            />
                            <div className="flex justify-end gap-3 pt-2">
                                ...
                                <button
                                    onClick={() => {
                                        if (onFav) {
                                            onFav(property.id, true, noteDraft);
